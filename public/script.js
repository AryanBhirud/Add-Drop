...
async function dropCourse() {
  ...
  try {
    ...
    if (!checker) {
      ...
      const data = await postRequest(student_id, selectedYear, selectedCourse, selectedFaculty, selectedSlot, "http://localhost:8080/drop");
...
async function postRequest(student_id, selectedYear, selectedCourse, selectedFaculty, selectedSlot, url) {
  const data = {
    student_id: student_id,
    year: selectedYear,
